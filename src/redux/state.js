let store = {
  ...
  dispatch(action) {
    ...
    if (action.type === "ADD-POST") {
    ...
    } else if (action.type === "ADD-SIMBOL-NEW-POST") {

      this._state.profilePage.newPostText = action.newText;
      this._callSubscriber(this._state);
    } else if (action.type === "ADD-SIMBOL-NEW-MESSAGE") {
      ...
      let myIndex = this._state.messages.newMessages.findIndex(item => item.getterId == item.getter);
